...
**Distributed LLM Inference Framework** | Mar 2026 - present
...
- **Tech:** Python, grpc, SGLang/RadixAttention, radix trees, KV cache management
...
**Evolutionary Policy Learning for Low-Level Tasks** | Aug 2025 - present
...
- Evidence Stage: Set up the gHoST framework on a testbed to simulate different workload benchmarks and test evolutionary algorithms generated by ShinkaEvolve.
...
**Procedural Video Generation for Instructional Videos** | Aug 2025 - present
...
- Extended the Identity-GRPO reward model by introducing an Object State Consistency Metric — a human-like verifier leveraging the Qwen-3 Vision-Language Model to track ingredient state transitions across steps and assess goal-consistency.
